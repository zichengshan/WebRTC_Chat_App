...
var $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab;
(function($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab) {
    $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab["Open"] = "open";
    $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab["Stream"] = "stream";
    $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab["Data"] = "data";
    $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab["Close"] = "close";
    $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab["Error"] = "error";
    $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab["IceStateChanged"] = "iceStateChanged";
})($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab || ($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab = {}));
        ...
        peerConnection.oniceconnectionstatechange = function() {
            switch(peerConnection.iceConnectionState){
                case "failed":
                    ...
                    _this.connection.emit($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Error, new Error("Negotiation of connection to " + peerId + " failed."));
                    _this.connection.close();
                    break;
                case "closed":
                    $c25b565240b6a41d$exports.default.log("iceConnectionState is closed, closing connections to " + peerId);
                    _this.connection.emit($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Error, new Error("Connection to " + peerId + " closed."));
                    _this.connection.close();
                    break;
                case "disconnected":
            ...
            _this.connection.emit($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.IceStateChanged, peerConnection.iceConnectionState);
        };
        // DATACONNECTION.
 ...
 */ var $9b5cc8dbdd0aa809$export$4a84e95a2324ac29 = /** @class */ function(_super) {
    ...
    $9b5cc8dbdd0aa809$export$4a84e95a2324ac29.prototype.addStream = function(remoteStream) {
        ...
        _super.prototype.emit.call(this, $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Stream, remoteStream); // Should we call this `open`?
    };
     ...
     */ /** Allows user to close connection. */ $9b5cc8dbdd0aa809$export$4a84e95a2324ac29.prototype.close = function() {
        ...
        if (!this.open) return;
        this._open = false;
        _super.prototype.emit.call(this, $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Close);
    };
 ...
 */ var $92db9a3ba21db2a0$export$d365f7ad9d7df9c9 = /** @class */ function(_super) {
    ...
    $92db9a3ba21db2a0$export$d365f7ad9d7df9c9.prototype._configureDataChannel = function() {
        ...
        this.dataChannel.onopen = function() {
            ...
            _this._open = true;
            _this.emit($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Open);
        };
    ...
    $92db9a3ba21db2a0$export$d365f7ad9d7df9c9.prototype._handleDataMessage = function(_a) {
        ...
        if (isBinarySerialization) {
            if (datatype === Blob) {
                ...
                $6c02be62bb157391$export$7debb50ef11d5e0b.blobToArrayBuffer(data, function(ab) {
                    ...
                    _this.emit($2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Data, unpackedData);
                });
                return;
        ...
        _super.prototype.emit.call(this, $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Data, deserializedData);
    };
    ...
    /** Allows user to send data. */ $92db9a3ba21db2a0$export$d365f7ad9d7df9c9.prototype.send = function(data, chunked) {
        if (!this.open) {
            _super.prototype.emit.call(this, $2f2cc37b22a0b29a$export$4aa6b1b0bfb253ab.Error, new Error("Connection is not open. You should listen for the `open` event before sending messages."));
            return;
        }
